...
def show_job_cards(jobs_df: pd.DataFrame) -> Optional[str]:
    ...
    if not st.session_state.get("_job_card_title_css_injected"):
        st.markdown(
            """
            <style>
            .job-card-title div[data-testid="stButton"] {
                width: 100%;
            }
            .job-card-title div[data-testid="stButton"] > button {
                width: 100%;
                background: none;
                border: none;
                padding: 0;
            ...
            .job-card-title div[data-testid="stButton"] > button:hover,
            .job-card-title div[data-testid="stButton"] > button:focus {
                color: #2563eb;
                outline: none;
            }
            .job-card-title div[data-testid="stButton"] > button::after {
                content: "\2192";
                font-size: 18px;
                opacity: 0;
            ...
            .job-card-title div[data-testid="stButton"] > button:hover::after,
            .job-card.is-active .job-card-title div[data-testid="stButton"] > button::after {
                opacity: 1;
                transform: translateX(0);
            }
            .job-card.is-active .job-card-title div[data-testid="stButton"] > button {
                color: #2563eb;
            }
            </style>
            """,
    ...
    for index, row in jobs_df.iterrows():
        ...
        button_label = str(raw_job_title)
        if st.button(button_label, key=f"select_{job_id_str}"):

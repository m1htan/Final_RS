...
body {
    ...
    background: linear-gradient(180deg, #f8fbff 0%, #eef2ff 45%, #fef6ff 100%);
    color: #0f172a;
}
...
.card {
    position: relative;
    overflow: hidden;
    background: linear-gradient(155deg, rgba(59, 130, 246, 0.18), rgba(14, 165, 233, 0.12) 45%, #ffffff 100%);
    border-radius: 20px;
    padding: 28px;
    margin-bottom: 24px;
...
.card::after {
    ...
    bottom: -160px;
    left: -80px;
    background: radial-gradient(circle at center, rgba(45, 212, 191, 0.32), transparent 72%);
}
...
.job-match-hero {
    position: relative;
    overflow: hidden;
    background: linear-gradient(140deg, rgba(59, 130, 246, 0.18), rgba(14, 165, 233, 0.12) 50%, rgba(168, 85, 247, 0.12) 100%);
...
.job-match-hero::before,
.job-match-hero::after {
    content: "";
    position: absolute;
    border-radius: 50%;
    pointer-events: none;
...
.job-match-hero::after {
    ...
    bottom: -120px;
    left: -70px;
    background: radial-gradient(circle at center, rgba(168, 85, 247, 0.38), transparent 72%);
}
...
.learning-hero::after {
    bottom: -160px;
    left: -120px;
    background: radial-gradient(circle at center, rgba(244, 114, 182, 0.38), transparent 70%);
}
...
.hero-chip {
    background: linear-gradient(135deg, rgba(59, 130, 246, 0.2), rgba(244, 114, 182, 0.2));
    color: #1e3a8a;
    font-weight: 600;
    padding: 6px 14px;
    border-radius: 999px;
...
.hero-metric {
    background: linear-gradient(160deg, rgba(14, 165, 233, 0.16), rgba(244, 114, 182, 0.12));
    border-radius: 18px;
    padding: 24px 20px;
    border: 1px solid rgba(148, 163, 184, 0.35);
    display: flex;
    flex-direction: column;
    gap: 6px;
    box-shadow: 0 16px 32px rgba(14, 116, 144, 0.18);
}
...
.learning-card {
    position: relative;
    overflow: hidden;
    background: linear-gradient(165deg, rgba(59, 130, 246, 0.12), rgba(244, 114, 182, 0.12) 45%, rgba(249, 115, 22, 0.08) 100%);
    border: 1px solid rgba(148, 163, 184, 0.35);
    border-radius: 22px;
    padding: 32px;
...
.learning-card::before {
    ...
    top: -140px;
    left: -80px;
    background: radial-gradient(circle at center, rgba(244, 114, 182, 0.42), transparent 72%);
}
...
.learning-card::after {
    ...
    bottom: -120px;
    right: -60px;
    background: radial-gradient(circle at center, rgba(249, 115, 22, 0.36), transparent 70%);
}
...
.grid-item {
    background: linear-gradient(160deg, rgba(59, 130, 246, 0.16), rgba(20, 184, 166, 0.14));
...
.ghost-button {
    background: linear-gradient(135deg, rgba(255, 255, 255, 0.95), rgba(224, 231, 255, 0.92));
    color: #1d4ed8;
...
.primary-button {
    background: linear-gradient(135deg, #6366f1, #22d3ee 45%, #f97316 100%);
    color: #ffffff;
...
.results-count {
    background: linear-gradient(135deg, rgba(224, 231, 255, 0.85), rgba(191, 219, 254, 0.85));
    color: #1e3a8a;
    border-radius: 999px;
    padding: 10px 18px;
    font-weight: 600;
...
.home-header {
    ...
    position: relative;
    overflow: hidden;
    background: linear-gradient(135deg, rgba(59, 130, 246, 0.18), rgba(129, 140, 248, 0.16) 45%, rgba(16, 185, 129, 0.12) 100%);
    padding: 24px 32px;
    border-radius: 18px;
    border: 1px solid rgba(148, 163, 184, 0.35);
...
.home-header::before {
    ...
    top: -120px;
    right: -80px;
    background: radial-gradient(circle at center, rgba(129, 140, 248, 0.42), transparent 70%);
}
...
.home-header::after {
    ...
    bottom: -120px;
    left: -60px;
    background: radial-gradient(circle at center, rgba(16, 185, 129, 0.35), transparent 68%);
}
...
.home-header-search {
    ...
    align-items: center;
    gap: 12px;
    background: linear-gradient(135deg, rgba(255, 255, 255, 0.75), rgba(224, 231, 255, 0.9));
    padding: 12px 16px;
    border-radius: 999px;
...
.legend-pill {
    background: linear-gradient(135deg, rgba(59, 130, 246, 0.22), rgba(129, 140, 248, 0.22));
    color: #1e3a8a;
    padding: 6px 14px;
    border-radius: 999px;
    font-weight: 600;
...
.legend-pill.upcoming {
    background: linear-gradient(135deg, rgba(96, 165, 250, 0.16), rgba(236, 72, 153, 0.18));
    color: #6b21a8;
}
...
.timeline-month {
    background: linear-gradient(135deg, rgba(191, 219, 254, 0.6), rgba(224, 231, 255, 0.45));
    border: 1px solid rgba(99, 102, 241, 0.35);
    border-radius: 14px;
    padding: 12px;
    display: flex;
...
.timeline-bar {
    ...
    justify-content: center;
    height: 44px;
    background: linear-gradient(135deg, rgba(59, 130, 246, 0.9), rgba(129, 140, 248, 0.85) 55%, rgba(16, 185, 129, 0.8));
    color: #ffffff;
    border-radius: 14px;
...
.progress-meter {
    position: relative;
    background: linear-gradient(90deg, rgba(15, 23, 42, 0.12), rgba(148, 163, 184, 0.18));
    border-radius: 999px;
    height: 12px;
    overflow: hidden;
    box-shadow: inset 0 0 0 1px rgba(255, 255, 255, 0.35), 0 6px 16px rgba(15, 23, 42, 0.1);
}

.home-dashboard .progress-fill {
    position: absolute;
    top: 0;
    left: 0;
    bottom: 0;
...
.search-icon {
    ...
    background: radial-gradient(circle at 30% 30%, rgba(129, 140, 248, 0.45), transparent 70%);
    position: relative;
}
